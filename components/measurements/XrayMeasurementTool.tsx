...
import { fetchXrayMeasurementsForEncounter, upsertXrayMeasurement } from "@/lib/xrayMeasurementRpc";
import { XRAY_PRESETS, presetsForSpecialty, type XrayPreset } from "@/components/measurements/xray-presets";
import type {
  CalibrationState,
  CanvasObject,
  CanvasPoint,
  ...
  ObjectType,
  Specialty,
} from "@/components/measurements/xray-types";
import {
  ...
  ratioOfLineLengths,
  scoliosisCobbStatus,
} from "@/components/measurements/xray-geometry";
