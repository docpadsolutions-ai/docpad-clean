  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-700 dark:bg-slate-900">
      <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-sm font-semibold text-slate-700 dark:text-slate-300">Collection by method</h2>
      ...
      {chartPreset === "custom" ? (
        <p className="mb-2 text-xs text-slate-500 dark:text-slate-400">Using the date range selected above.</p>
      ) : null}
