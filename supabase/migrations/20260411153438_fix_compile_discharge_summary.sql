...
-- This is the SQL the database records as having actually run, on 20260411153438.
...
BEGIN
  ...
  SELECT
    pt.id, pt.full_name, pt.date_of_birth, pt.sex, pt.docpad_id,
  ...
  SELECT os.id, os.surgery_name, os.surgery_date, os.anaesthesia_type,
    os.surgeon_name, os.procedure_notes, os.implants_used, os.duration_minutes, os.status
  INTO v_surgery
