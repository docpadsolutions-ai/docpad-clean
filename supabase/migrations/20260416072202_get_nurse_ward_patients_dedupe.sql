...
-- This is the SQL the database records as having actually run, on 20260416072202.

-- Fix duplicate patient cards when a nurse has both a shift-specific assignment (e.g. Morning)
-- and a 'general' assignment for the same ward/date — both rows matched the RPC filter.
